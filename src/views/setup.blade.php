...
@endif
 ...
 <script type="text/javascript">
    ...
    var serial_number_type_list_template_url = "{{URL::asset($serial_number_prefix .'/public/themes/'.$theme.'/serial-number-pkg/serial-number-type/list.html')}}";
    var serial_number_type_get_form_data_url = "{{url('serial-number-pkg/serial-number-types/add/')}}";
    var serial_number_type_form_template_url = "{{URL::asset($serial_number_prefix .'/public/themes/'.$theme.'/serial-number-pkg/serial-number-type/form.html')}}";
    var serial_number_type_delete_data_url = "{{url('serial-number-pkg/serial-number-types/delete/')}}";
</script>
<!-- <script type="text/javascript" src="{{URL::asset($serial_number_prefix .'/public/themes/'.$theme.'/serial-number-pkg/serial-number-type/controller.js?v=2')}}"></script> -->
 <!-- ------------------------------------------------------------------------------------------ -->
 <!-- ------------------------------------------------------------------------------------------ -->
<script type="text/javascript">
    var serial_number_segment_list_template_url = "{{URL::asset($serial_number_prefix .'/public/themes/'.$theme.'/serial-number-pkg/serial-number-segment/list.html')}}";
    var serial_number_segment_get_form_data_url = "{{url('serial-number-pkg/serial-number-segments/add/')}}";
    var serial_number_segment_form_template_url = "{{URL::asset($serial_number_prefix .'/public/themes/'.$theme.'/serial-number-pkg/serial-number-segment/form.html')}}";
    var serial_number_segment_delete_data_url = "{{url('serial-number-pkg/serial-number-segments/delete/')}}";
</script>
<!-- <script type="text/javascript" src="{{URL::asset($serial_number_prefix .'/public/themes/'.$theme.'/serial-number-pkg/serial-number-segment/controller.js?v=2')}}"></script> -->
 <!-- ------------------------------------------------------------------------------------------ -->
 <!-- ------------------------------------------------------------------------------------------ -->

 <script type="text/javascript">
    var serial_number_group_list_template_url = "{{URL::asset($serial_number_prefix .'/public/themes/'.$theme.'/serial-number-pkg/serial-number-group/list.html')}}";
    var serial_number_group_get_form_data_url = "{{url('serial-number-pkg/serial-number-groups/add/')}}";
    var serial_number_group_form_template_url = "{{URL::asset($serial_number_prefix .'/public/themes/'.$theme.'/serial-number-pkg/serial-number-group/form.html')}}";
...
<!-- <script type="text/javascript" src="{{URL::asset($serial_number_prefix .'/public/themes/'.$theme.'/serial-number-pkg/serial-number-group/controller.js?v=2')}}"></script> -->
